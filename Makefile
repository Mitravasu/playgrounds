...
.PHONY: help setup sync browsers sandbox-image analyzer analyzer-up analyzer-down creator test lint format format-check typecheck lock check
...
help:
	...
	@echo "sandbox-image  Build the offline browser and Storybook image"
